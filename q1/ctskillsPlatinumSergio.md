...
2. Student-and-teacher users may accidentally swap, have duplicate, or lack items from their orders due to system errors.
3. Menu items may become unavailable for users and lead to shortage.
4. The cashier will have difficulty in calculations due to its slow, manual process.
---
## Step 3: Apply Computational Thinking Skills
| System/Internet Crash | Decompostion | Use data backups or resort back to manual queueing until data connectivity is restored. |
